...
class AddExercise: UITableViewController{
    ...
    func setupNavBar(){
        ...
        let cancelItem = UIBarButtonItem(title: "Calcel", style: .plain, target: self, action: #selector(cancel))
...
/*
 ...
 class AddExercise: UITableViewController{
     ...
     func setupToolBar(){
         ...
         let spaceButton = UIBarButtonItem(title: " ", style: UIBarButtonItem.Style.plain, target: self, action: nil)
